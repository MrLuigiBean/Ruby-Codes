...
puts"Your four letter goal word has been generated!"
print"What is your guess?: "
i=gets.chomp.downcase
lf=i.length!=4
cf=(i[0]==i[1])||(i[0]==i[2])||(i[0]==i[3])||(i[1]==i[2])||(i[1]==i[3])||(i[2]==i[3])
v(i)
...
if k==0
if g[k]==i[1]||g[k]==i[2]||g[k]==i[3]
c+=1
end
elsif k==1
if g[k]==i[0]||g[k]==i[2]||g[k]==i[3]
c+=1
end
elsif k==2
if g[k]==i[0]||g[k]==i[1]||g[k]==i[3]
c+=1
end
elsif k==3
if g[k]==i[0]||g[k]==i[1]||g[k]==i[2]
c+=1
end
end
end
