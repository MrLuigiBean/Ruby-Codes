...
def guess_process(goal, guess, counter)
...
def thegame(counter)
	 ...
	 print "What is your guess?: " 
	 guess= gets.chomp.downcase
	 guess_process(goal, guess, counter)
end

def gamestart(x,counter)
	 if x== "yes"
		 puts
